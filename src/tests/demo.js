!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).ReporterPb = t()
}(this, (function() {
    "use strict";
    function e(e, t) {
    ...
    function c() {
        ...
        ;
        var e, t = {}, i = Object.prototype, r = i.hasOwnProperty, n = Object.defineProperty || function(e, t, i) {
            e[t] = i.value
        }
        ...
        var F = y.prototype = m.prototype = Object.create(_);
        function S(e) {
        ...
        function P(t, i) {
            ...
            if (n === e)
                ...
                "throw" === r && t.iterator.return && (i.method = "return",
                i.arg = e,
                P(t, i),
            ...
            if ("throw" === o.type)
                ...
                b;
            var a = o.arg;
            return a ? a.done ? (i[t.resultName] = a.value,
            i.next = t.nextLoc,
    ...
    function w(e) {
        return new this((function(t, i) {
            if (!e || void 0 === e.length)
                return i(new TypeError(p(e) + " " + e + " is not iterable(cannot read property Symbol(Symbol.iterator))"));
    ...
    function m(e) {
        ...
        return new t((function(i, r) {
            ...
            for (var o = [], a = 0; a < n.length; a++)
                try {
                    t.resolve(n[a]).then(i).catch((function(e) {
                        o.push(e),
                        o.length === n.length && r(new b(o,"All promises were rejected"))
                    }
                    ))
                } catch (e) {
                    r(e)
    ...
    function x(e, t) {
        ...
        k._immediateFn((function() {
            ...
            if (null !== i) {
                ...
                (1 === e._state ? F : S)(t.promise, e._value)
        }
        ))) : e._deferreds.push(t)
    }
    function F(e, t) {
    ...
    k.resolve = function(e) {
        return e && "object" === p(e) && e.constructor === k ? e : new k((function(t) {
            t(e)
        }
        ))
    }
    ...
    "function" != typeof T.Promise ? T.Promise = k : (T.Promise.prototype.finally || (T.Promise.prototype.finally = h),
    T.Promise.allSettled || (T.Promise.allSettled = w),
    T.Promise.any || (T.Promise.any = m));
    var O = "1.1.6"
      , j = function() {
        return o((function e(t) {
            ...
            key: "flush",
            value: (e = i(c().mark((function e() {
                var t, i, r, n, o, a = arguments;
                return c().wrap((function(e) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            this.timeout = 0,
                            this.batched.length && (t = this.batched,
                            this.batched = [],
                            t.length)) {
                                for (r = a.length,
                                n = new Array(r),
                                o = 0; o < r; o++)
                                    n[o] = a[o];
                                (i = this.options).run.apply(i, [t].concat(n))
                            }
                        case 3:
                        case "end":
                            return e.stop()
            ...
            value: function() {
                var e = this;
                this.batched.length >= this.options.batchSize ? this.flush() : 0 === this.timeout && (this.timeout = window.setTimeout((function() {
                    return e.flush()
                }
      ...
      , q = function(e) {
        var t = function(t) {
            var i, r = null == t || null === (i = t.match) || void 0 === i ? void 0 : i.call(t, new RegExp("(^|&)" + e + "=([^&]*)(&|$)"));
      ...
      , A = function(e, t) {
        var i = e.indexOf("?")
          , r = [];
        for (var n in t)
            r.push("".concat(encodeURIComponent(n), "=").concat(encodeURIComponent(t[n])));
      ...
      , B = function(e, t) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0
          , r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "same-domain"
          , n = new Date;
        n.setTime(n.getTime() + 1e3 * i);
        var o = i > 0 ? ";expires=" + n.toUTCString() : "";
        return "same-domain" === r && (r = "." + document.domain.split(".").slice(-2).join(".")),
        document.cookie = e + "=" + encodeURIComponent(t) + o + (r ? ";domain=".concat(r, ";path=/") : ""),
        t
    }
      , I = function(e) {
      ...
      , C = function(e) {
        for (var t = "", i = 0; i < e; i++)
            t += Math.floor(16 * Math.random()).toString(16).toUpperCase();
        return t
    }
      , R = function(e) {
        return "object" === p(e) && !Array.isArray(e)
    }
      , L = function(e) {
        ...
        if (R(n))
            for (var o in n)
                R(n[o]) ? (e[o] || (e[o] = {}),
                L(e[o], n[o])) : e[o] = n[o];
        return L.apply(void 0, [e].concat(i))
    }
      , D = function(e, t) {
      ...
      , z = function(e, t) {
        var i = {}
          ...
          , n = function(n) {
            ...
            )) && void 0 !== e[n] && null !== e[n] ? i[n] = e[n] : r[n] = e[n]
        };
        for (var o in e)
            n(o);
        return {
            ...
            if (void 0 !== e[i] && null !== e[i])
                if ("object" === p(e[i]))
                    try {
                        ...
                        var o, a;
                        t[i] = (null === (o = (a = e[i]).toString) || void 0 === o ? void 0 : o.call(a)) || ""
                    }
                else
                    t[i] = (null === (r = (n = e[i]).toString) || void 0 === r ? void 0 : r.call(n)) || ""
        }
        return t
    }
      , G = function(e) {
      ...
      , Q = function(e) {
        var t, i;
        return null !== (t = null === (i = window.__ReporterPbGlobalState) || void 0 === i ? void 0 : i[e]) && void 0 !== t ? t : null
    }
      , W = function(e, t) {
      ...
      , Z = function() {
        var e = N("b_lsid") || "";
        if (function(e) {
            var t, i = parseInt((null === (t = e.split("_")) || void 0 === t ? void 0 : t[1]) || "", 16) || 0;
            if (i + 54e5 < Date.now())
                return !1;
            var r = new Date(i);
            r.setHours(0, 0, 0, 0);
            ...
            r.getTime() === n.getTime() && void 0
        }(e)) {
            var t = Date.now().toString(16).toUpperCase()
              , i = "".concat(C(8), "_").concat(t);
            return B("b_lsid", i, 0, "same-domain"),
            i
        }
        return e
    }
      , X = function() {
        var e, t, i = ((t = q("bsource")) ? (B("bsource_origin", t),
        {
            bsource: t,
            bsourceFrom: "url"
        }) : null) || function() {
            var e = q("share_source");
            if (!e)
                return null;
            B("share_source_origin", e);
            var t = {
        ...
        return i.bsource && B("bsource", i.bsource),
        i
    }
      , $ = function() {
        var e = parseInt(I("spm_ptype") || "") || 0;
        if (e)
            return e;
    ...
    !function(e, t) {
        !function(i, r) {
            var n = "function"
              ...
              , H = function(e, t) {
                return p(e) === s && -1 !== Q(t).indexOf(Q(e))
            }
              , Q = function(e) {
              ...
              , W = function(e, t) {
                if (p(e) === s)
                    ...
                    p(t) === o ? e : e.substring(0, 500)
            }
              , Z = function(e, t) {
                for (var i, o, s, u, l, c, d = 0; d < t.length && !l; ) {
                    var f = t[d]
                      , v = t[d + 1];
                    for (i = o = 0; i < f.length && !l && f[i]; )
                        if (l = f[i++].exec(e))
                            for (s = 0; s < v.length; s++)
                                c = l[++o],
                                p(u = v[s]) === a && u.length > 0 ? 2 === u.length ? p(u[1]) == n ? this[u[0]] = u[1].call(this, c) : this[u[0]] = u[1] : 3 === u.length ? p(u[1]) !== n || u[1].exec && u[1].test ? this[u[0]] = c ? c.replace(u[1], u[2]) : r : this[u[0]] = c ? u[1].call(this, c, u[2]) : r : 4 === u.length && (this[u[0]] = c ? u[3].call(this, c.replace(u[1], u[2])) : r) : this[u] = c || r;
                    d += 2
                }
            }
              , X = function(e, t) {
                for (var i in t)
                    if (p(t[i]) === a && t[i].length > 0) {
              ...
              , J = function(e, t) {
                ...
                var w = p(i) !== o && i.navigator ? i.navigator : r
                  , g = e || (w && w.userAgent ? w.userAgent : "")
                  , y = w && w.userAgentData ? w.userAgentData : r
                  , _ = t ? function(e, t) {
                    var i = {};
                    for (var r in e)
                ...
                return this.getBrowser = function() {
                    ...
                    return t[c] = r,
                    t[v] = r,
                    Z.call(t, g, _.browser),
                    t[u] = p(e = t[v]) === s ? e.replace(/[^\d\.]/g, "").split(".")[0] : r,
                    k && w && w.brave && p(w.brave.isBrave) == n && (t[c] = "Brave"),
                    t
                }
                ,
                ...
                this.getDevice = function() {
                    ...
                    e[d] = r,
                    Z.call(e, g, _.device),
                    k && !e[d] && y && y.mobile && (e[d] = b),
                    k && "Macintosh" == e[l] && w && p(w.standalone) !== o && w.maxTouchPoints && w.maxTouchPoints > 2 && (e[l] = "iPad",
                    e[d] = m),
                    e
                }
                ,
                ...
                this.getOS = function() {
                    ...
                    e[v] = r,
                    Z.call(e, g, _.os),
                    k && !e[c] && y && y.platform && "Unknown" != y.platform && (e[c] = y.platform.replace(/chrome os/i, D).replace(/macos/i, z)),
                    e
                }
                ,
                ...
                this.setUA = function(e) {
                    return g = p(e) === s && e.length > 500 ? W(e, 500) : e,
                    this
                }
                ,
                this.setUA(g),
            ...
            J.BROWSER = G([c, v, u]),
            J.CPU = G([h]),
            J.DEVICE = G([l, f, d, w, b, g, m, y, _]),
            J.ENGINE = J.OS = G([c, v]),
            e.exports && (t = e.exports = J),
            t.UAParser = J;
            var K = p(i) !== o && (i.jQuery || i.Zepto);
            if (K && !K.ua) {
                var ee = new J;
                K.ua = ee.getResult(),
                K.ua.get = function() {
        ...
        }("object" === ("undefined" == typeof window ? "undefined" : p(window)) ? window : Y)
    }(J, J.exports);
    var K = J.exports
      , ee = null
      , te = function() {
      ...
      , re = function() {
        var e, t, i = te(), r = i.getDevice(), n = i.getOS(), o = n.name ? "".concat(n.name).concat(n.version ? " " + n.version : "") : "", a = navigator.userAgent;
        !o && /OpenHarmony/.test(a) && (o = null !== (e = null === (t = a.match(/(OpenHarmony ?[\d.]*)/)) || void 0 === t ? void 0 : t[1]) && void 0 !== e ? e : "");
        return {
            brand: r.vendor || "",
            model: r.model || "",
            system: o
      ...
      , ne = function(e) {
        var t, i;
        return {
            app_id: null !== (t = null == e ? void 0 : e.appId) && void 0 !== t ? t : 100,
            platform: (null !== (i = null == e ? void 0 : e.platform) && void 0 !== i ? i : /AppleWebKit.*Mobile.*/i.test(navigator.userAgent)) ? 6 : 5,
            cbuvid: N("buvid3") || "",
            cmid: parseInt(N("DedeUserID") || "0"),
            fts: N("b_nut") || "",
      ...
      , oe = function(e) {
        var t, i, r, n;
        return {
            network_info: null !== (t = null !== (i = null == e ? void 0 : e.networkInfo) && void 0 !== i ? i : null === (r = navigator.connection) || void 0 === r ? void 0 : r.effectiveType) && void 0 !== t ? t : "4g",
            url: window.location.href,
            refer_url: document.referrer,
            logver: O,
            abtest: JSON.stringify(null !== (n = window.abtest) && void 0 !== n ? n : {}),
            ptype: $(),
            window_size: "".concat(window.innerWidth, "*").concat(window.innerHeight),
            bsource: X().bsource,
            bsource_origin: q("bsource") || "",
            share_source_origin: q("share_source") || "",
            share_session_id: q("unique_k") || "",
            session_id: Z()
        }
    }
      , ae = function() {
        var e, t, i, r, n, o = null === (e = window.performance) || void 0 === e || null === (t = e.getEntriesByType) || void 0 === t || null === (t = t.call(e, "navigation")) || void 0 === t ? void 0 : t[0];
        if (o) {
            var a;
            return null !== (a = {
                navigate: 0,
        ...
        return null !== (i = window.performance) && void 0 !== i && i.navigation && null !== (r = null === (n = window.performance) || void 0 === n || null === (n = n.navigation) || void 0 === n ? void 0 : n.type) && void 0 !== r ? r : 0
    }
      , se = {
        enabled: !0,
        value: {
      ...
      , ce = N("buvid3") || ""
      , de = ce ? function(e) {
        for (var t = 5381, i = 0; i < e.length; i++)
    ...
    var ve, he = function(e) {
        ...
        return new Promise((function(e, s) {
            if (a.open(i.toUpperCase(), t),
            o && "omit" === o || (a.withCredentials = !0),
            a.responseType = "text",
            n)
                for (var u in n)
                    a.setRequestHeader(u, n[u]);
            ...
            return c().wrap((function(e) {
                for (; ; )
                    ...
                    case 3:
                        ...
                        throw new Error("".concat(u.status, " ").concat(u.statusText));
                    case 6:
        ...
        var e = i(c().mark((function e(t) {
            ...
            return c().wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        return i = "function" == typeof window.fetch ? we : he,
                        e.abrupt("return", i(t));
                    case 2:
                    case "end":
                        return e.stop()
    ...
    le && ((me = null !== (ve = Q("maxErrorCount")) && void 0 !== ve ? ve : 0) || (me = 20 + Math.floor(10 * Math.random()),
    W("maxErrorCount", me)));
    var ge = le && "function" == typeof window.fetch
      , ye = le && ge && window.Request && "keepalive"in Request.prototype
      , _e = le && "function" == typeof navigator.sendBeacon
      , ke = function() {
        var e = i(c().mark((function e(t, i) {
            var r, n, o, a, s, u, d, f, p, v, h, w, b, m, g;
            return c().wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        if (o = null !== (r = Q("errReqCount")) && void 0 !== r ? r : 0,
                        !(pe && o >= me)) {
                            e.next = 3;
                            break
                        }
                    ...
                    case 3:
                        return a = null !== (n = null == i ? void 0 : i.url) && void 0 !== n ? n : "//data.bilibili.com/v2/log/web",
                        a = A(a, {
                        ...
                        : _e ? function() {
                            if (!navigator.sendBeacon(a, new Blob([t],{
                                type: "text/plain"
                            })))
                                return ge ? we(l(l({}, s), {}, {
                                    keepalive: !1
                    ...
                    case 14:
                        ...
                        e.t0 = e.catch(8),
                        xe(),
                        !(f = D(ue, null == i ? void 0 : i.retry)).enabled) {
                            e.next = 32;
                            break
                        }
                        p = f.value,
                        ...
                        m = c().mark((function e() {
                            ...
                            return c().wrap((function(e) {
                                for (; ; )
                                    switch (e.prev = e.next) {
                                    case 0:
                                        return i = Math.random() * v,
                                        r = Math.min(1e3 * Math.pow(v / 1e3, b), h) + i,
                                        e.next = 4,
                                    ...
                                    case 4:
                                        if (n = null !== (t = Q("errReqCount")) && void 0 !== t ? t : 0,
                                        !(pe && n >= me)) {
                                            e.next = 7;
                                            break
                                        }
                    ...
                    case 22:
                        ...
                        return e.delegateYield(m(), "t1", 24);
                    case 24:
                        if (!(g = e.t1)) {
                            e.next = 27;
                            break
                    ...
                    case 27:
                        ...
                        break;
                    case 29:
                        console.error("[reporter-pb]: max retries exceeded", e.t0, s.body),
                        e.next = 33;
                        break;
                    case 32:
    ...
    function xe() {
        ...
        if (!pe)
            return !1;
        var t = (null !== (e = Q("errReqCount")) && void 0 !== e ? e : 0) + 1;
        if (W("errReqCount", t),
        t === me) {
            var i = /^uat-/.test(location.hostname) ? location.hostname.slice(0, 4) : "";
            be({
                url: "https://".concat(i, "api.bilibili.com/x/web-frontend/data/report"),
                method: "post",
                body: JSON.stringify({
                    level: "ERROR",
                    event: "reporter-request-blocked",
                    extra: {
                        spm_prefix: I("spm_prefix"),
                        url: window.location.href,
                        buvid3: N("buvid3"),
                        mid: N("DedeUserID"),
    ...
    var Fe = function(e) {
            ...
            return c().wrap((function(e) {
                for (; ; )
                    ...
                    case 16:
                        ...
                        return e.abrupt("return");
                    case 18:
                        n = Fe((null === (t = r) || void 0 === t || null === (t = t.data) || void 0 === t ? void 0 : t.b_3) || "") ? r.data.b_3 : (a = void 0,
                        s = void 0,
                        a = C,
                        s = ("00000" + (Date.now() % 1e5).toString()).slice(-5),
                        "".concat(a(8), "-").concat(a(4), "-").concat(a(4), "-").concat(a(4), "-").concat(a(12)).concat(s, "infoc")),
                        Se(N("buvid3") || "") || (B("buvid3", n, 94608e3, "same-domain"),
                        B("b_nut", Math.floor(Date.now() / 1e3).toString(), 94608e3, "same-domain")),
                        o = (null === (i = r) || void 0 === i || null === (i = i.data) || void 0 === i ? void 0 : i.b_4) || "",
                        !Fe(N("buvid4") || "") && Fe(o) && B("buvid4", o, 94608e3, "same-domain");
                    case 22:
                    case "end":
                        return e.stop()
                    }
      ...
      , Pe = 4294967296
      , Te = 1 / Pe
      , Oe = "undefined" == typeof TextDecoder ? null : new TextDecoder("utf-8")
      , je = function() {
        return o((function e() {
            ...
            key: "readFields",
            value: function(e, t) {
                for (var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.length; this.pos < i; ) {
            ...
            key: "readFixed64",
            value: function() {
                var e = this.dataView.getUint32(this.pos, !0) + this.dataView.getUint32(this.pos + 4, !0) * Pe;
                return this.pos += 8,
                e
            }
        }, {
            key: "readSFixed64",
            value: function() {
                var e = this.dataView.getUint32(this.pos, !0) + this.dataView.getInt32(this.pos + 4, !0) * Pe;
                return this.pos += 8,
                e
            }
        }, {
            ...
            value: function() {
                var e = this.readVarint() + this.pos
                  , t = this.pos;
                return this.pos = e,
                e - t >= 12 && Oe ? Oe.decode(this.buf.subarray(t, e)) : function(e, t, i) {
                    var r = ""
                      , n = t;
                    for (; n < i; ) {
                        var o = e[n]
                        ...
                        var u = void 0
                          , l = void 0
                          , c = void 0;
                        1 === s ? o < 128 && (a = o) : 2 === s ? 128 == (192 & (u = e[n + 1])) && (a = (31 & o) << 6 | 63 & u) <= 127 && (a = null) : 3 === s ? (u = e[n + 1],
                        l = e[n + 2],
                        128 == (192 & u) && 128 == (192 & l) && ((a = (15 & o) << 12 | (63 & u) << 6 | 63 & l) <= 2047 || a >= 55296 && a <= 57343) && (a = null)) : 4 === s && (u = e[n + 1],
                        l = e[n + 2],
                        c = e[n + 3],
                        128 == (192 & u) && 128 == (192 & l) && 128 == (192 & c) && ((a = (15 & o) << 18 | (63 & u) << 12 | (63 & l) << 6 | 63 & c) <= 65535 || a >= 1114112) && (a = null)),
                        null === a ? (a = 65533,
                        s = 1) : a > 65535 && (a -= 65536,
            ...
            value: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 ? arguments[1] : void 0, i = this.readPackedEnd(); this.pos < i; )
            ...
            value: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = this.readPackedEnd(); this.pos < t; )
            ...
            value: function(e) {
                ...
                if (0 === t)
                    ...
                    if (1 !== t)
                        throw new Error("Unimplemented type: ".concat(t));
                    this.pos += 8
                }
            }
        }, {
            ...
            value: function(e) {
                ...
                this.dataView.setInt32(this.pos + 4, Math.floor(e * Te), !0),
                this.pos += 8
            }
        }, {
            key: "writeSFixed64",
    ...
    var Ue = function() {
        var e = window._GreyResult || window._BiliGreyResult
          , t = {};
        e && Object.keys(e).forEach((function(i) {
            "grayVersion" === i ? t._BiliGreyResult_versionId = e[i] : t["_BiliGreyResult_".concat(i)] = e[i]
        }
        ));
        return t
    };
    function Ge(e, t) {
        if (e.log_id && t.writeStringField(1, e.log_id),
    ...
    function Xe(e, t) {
        if (e.target_url && t.writeStringField(1, e.target_url),
    ...
    function Ye(e, t) {
        if (e.event_id_from && t.writeStringField(1, e.event_id_from),
    ...
    function rt(e, t) {
        if (e.spm_id && t.writeStringField(1, e.spm_id),
        ...
        e.player_playback_state && t.writeVarintField(17, e.player_playback_state),
        ...
        e.player_extra)
            for (var i = 0, r = Object.keys(e.player_extra); i < r.length; i++) {
                var n = r[i];
                t.writeMessage(28, nt, {
                    key: n,
                    value: e.player_extra[n]
                })
            }
    }
    function nt(e, t) {
    ...
    var ot = {
      ...
      , at = function(e, t) {
        var i, r, n, o = t.reporter.options, a = t.reporter.sequencer.get(), s = a.sn, u = a.time, c = {
            pv: function() {
                return {
                    page_view_info: {
                        event_id_from: q("spm_id_from") || q("from_spmid") || "",
                        load_type: ae(),
                        pv_start: e.ts || 0,
                        extra: U(l(l({}, null == o ? void 0 : o.extra), e.data))
                    }
                }
            },
            pv_unload: function() {
                var t, i, r, n, a = e.ts, s = null !== (t = null !== (i = null === (r = e.data) || void 0 === r ? void 0 : r.pvStart) && void 0 !== i ? i : null === (n = performance) || void 0 === n ? void 0 : n.timeOrigin) && void 0 !== t ? t : a, u = a - s, c = z(l(l({}, null == o ? void 0 : o.extra), e.data), ["pvStart"]).remain;
                return {
            ...
            click: function() {
                var t, i, r, n = ["targetUrl", "buttonType", "targetEventId"];
                n = n.concat(n.map((function(e) {
                    return G(e)
                }
                )));
                var a = z(l(l({}, null == o ? void 0 : o.extra), e.data), n)
                  , s = a.selected
                  , u = a.remain
                  , c = H(s);
                return {
                    click_info: {
                        target_url: null !== (t = c.target_url) && void 0 !== t ? t : "",
                        button_type: null !== (i = c.button_type) && void 0 !== i ? i : 0,
                        target_event_id: null !== (r = c.target_event_id) && void 0 !== r ? r : "",
                        extra: U(u)
                    }
                }
            },
            ...
            player: function() {
                return e.data = H(e.data),
                e.data.player_extra && (e.data.player_extra = U(e.data.player_extra)),
                {
                    player_info: e.data
                }
            },
            custom: function() {
                return {
                    extra: U(l(l(l(l({
                        app_buvid: N("Buvid")
                    }, Ue()), re()), null == o ? void 0 : o.extra), e.data))
                }
            }
        }, d = (null === (i = c[e.type]) || void 0 === i ? void 0 : i.call(c)) || {}, f = l(l({}, null == o ? void 0 : o.base), null === (r = e.options) || void 0 === r ? void 0 : r.base), p = l({
            info: ne(f),
            runtime_info: oe(f),
            event_id: e.spm,
            ...
            event_category: ot[e.type],
            extra: U(l(l(l(l({
                app_buvid: N("Buvid")
            }, Ue()), re()), null == o ? void 0 : o.extra), fe ? {
                _report_exp: pe ? 2 : 1
            } : {}))
        }, d), v = new je;
        !function(e, t) {
            if (e.info && t.writeMessage(1, We, e.info),
            e.runtime_info && t.writeMessage(2, Ze, e.runtime_info),
            ...
            e.page_view_info && t.writeMessage(10, Ye, e.page_view_info),
            e.exposure_info && t.writeMessage(11, tt, e.exposure_info),
            e.click_info && t.writeMessage(12, Xe, e.click_info),
            e.player_info && t.writeMessage(13, rt, e.player_info),
            e.page_view_unload_info && t.writeMessage(14, Ke, e.page_view_unload_info),
            e.extra)
                for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
                    var n = r[i];
                    t.writeMessage(15, Qe, {
                        key: n,
                        value: e.extra[n]
                    })
                }
        ...
        var h = v.finish();
        return (null == o ? void 0 : o.logLevel) >= 1 && console.log("%c".concat(e.type, " ").concat(e.spm, "\n"), "color: #30A46C", p),
        {
            log_id: (null == f ? void 0 : f.logId) || (null !== (n = t.reporter.options) && void 0 !== n && n.DEBUG_TEST_CHANNEL ? "025219" : "021436"),
            event_id: e.spm,
            body: h,
            meta: {}
        }
      ...
      , lt = function() {
        var e;
        ut || (ut = null !== (e = window.__BMG_AF__) && void 0 !== e ? e : null);
        return ut
    }
      , ct = function() {
        var e = i(c().mark((function e() {
            ...
            return c().wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
                        return i = (null === (t = lt()) || void 0 === t ? void 0 : t.defDomain) || "i0.hdslb.com",
                        r = /^uat-/.test(location.hostname) ? location.hostname.slice(0, 4) : "",
                        e.prev = 2,
                        e.next = 5,
                        be({
                            method: "get",
                            url: "//".concat(r).concat(i, "/bfs/polaris_web_conf/polaris/webcnf/event.cnf"),
                            credentials: "omit"
                        });
                    case 5:
                        (n = e.sent) && (null === (o = window.localStorage) || void 0 === o || o.setItem("__reporter-pb-sample-config", n),
                        W("sampleRateConfig", JSON.parse(n))),
                        e.next = 12;
                        break;
                    case 9:
                        e.prev = 9,
                        e.t0 = e.catch(2),
                        console.warn("[reporter-pb] fetch sample rate config failed");
                    case 12:
                    case "end":
                        return e.stop()
                    }
      ...
      , ft = function() {
        function e(t) {
            ...
            r(this, e),
            s(this, "version", O),
            s(this, "techEventReporter", null),
            s(this, "fpPromise", null),
            this.miss = Math.random() > (null !== (n = null === (o = this.options) || void 0 === o ? void 0 : o.sampleRate) && void 0 !== n ? n : 1);
            var p = "undefined" != typeof window
              , v = p && /\bDEBUG_TEST_CHANNEL=1\b/.test(window.location.search + window.location.hash)
              , h = p && !!N("DEBUG_TEST_CHANNEL");
            v && B("DEBUG_TEST_CHANNEL", "1", 0, "same-domain"),
            this.options = l(l({}, t), {}, {
                DEBUG_TEST_CHANNEL: (null == t ? void 0 : t.DEBUG_TEST_CHANNEL) || v || h
            });
            var w = e.plugins.native
              , b = Q("initBuvidPromise");
            b || (b = Promise.all([Ve()].concat(d(w ? [w.initBuvid()] : []))).then((function() {
                f.buvidInit = !0
            }
            )),
            W("initBuvidPromise", b)),
            this.initBuvidPromise = b;
            var m = X()
              , g = {
                bsource: m.bsource,
                bsourceFrom: m.bsourceFrom,
                uaSource: function() {
                    var e = navigator.userAgent.toLowerCase()
                      , t = function() {
                        return /chrome/i.test(e) || /\b(?:crmo|crios)\/([\w\.]+)/i.test(e)
                    }
                      , i = {
                        qq: function() {
                        ...
                        chromebrowser: t,
                        "360browser": function() {
                            return /\bqihu|(qi?ho?o?|360)browser/i.test(e) || t() && !window.navigator.webkitPersistentStorage || Object.keys(window).some((function(e) {
                                return /qihoo/.test(e)
                            }
                            ))
                        }
                    ...
                    for (var r in i) {
                        ...
                        if (Array.isArray(n)) {
                            for (var o = 0; o < n.length; o++)
                                if (e.indexOf(n[o].toLocaleLowerCase()) >= 0)
                                    return r
                        } else if ("string" == typeof n) {
                            if (e.indexOf(n.toLocaleLowerCase()) >= 0)
                                return r
                        } else if ("function" == typeof n && n())
                            return r
                    }
                    return ""
                }()
            ...
            this.sequencer = new M;
            var y, _ = D(se, null === (a = this.options) || void 0 === a ? void 0 : a.batch);
            this.scheduler = new j(l(l({}, _.enabled ? _.value : {
                batchSize: 1,
                batchTime: 0
            }), {}, {
                run: (y = i(c().mark((function e(t) {
                    var i, r, n, o, a, s, u, l;
                    return c().wrap((function(e) {
                        for (; ; )
                            switch (e.prev = e.next) {
                            case 0:
                                return e.prev = 0,
                                s = (null === (i = f.options) || void 0 === i || null === (i = i.base) || void 0 === i ? void 0 : i.logId) || (null !== (r = f.options) && void 0 !== r && r.DEBUG_TEST_CHANNEL ? "025219" : "021436"),
                                u = st(t),
                                (null === (n = f.options) || void 0 === n ? void 0 : n.logLevel) >= 2 && (l = d(u).map((function(e) {
                                    return "0".concat(e.toString(16)).slice(-2)
                                }
                                )).join(" "),
                                console.log("log_id: %c".concat(s, "\n%crequest size: %c").concat(u.length, " bytes\n%crequest body:\n%c").concat(l), "color: #0090FF", "", "color: #0090FF", "", "background-color: #004744; color: #A8F5E5")),
                                e.next = 6,
                                ke(u, {
                                    url: null === (o = f.options) || void 0 === o || null === (o = o.base) || void 0 === o ? void 0 : o.url,
                                    retry: null === (a = f.options) || void 0 === a ? void 0 : a.retry,
                                    logId: s
                                });
                            case 6:
                                e.next = 11;
            ...
            var k = null;
            this.spmPrefix && !1 !== (null == t ? void 0 : t.autoPv) && p && !Q("autoPvReported") && (k = this.pv(),
            e.plugins.native && this.reportNative({
            ...
            W("autoPvReported", !0)),
            function() {
                var e = Q("fetchSampleRateTimer");
                if (!e) {
                    try {
                        var t, i = null === (t = window.localStorage) || void 0 === t ? void 0 : t.getItem("__reporter-pb-sample-config");
                        i && W("sampleRateConfig", JSON.parse(i))
                    } catch (e) {}
                    ct(),
                    e = window.setInterval(ct, 12e4),
                    W("fetchSampleRateTimer", e)
                }
            }();
            var x = function() {
                var e;
                null !== k && !1 !== (null == t || null === (e = t.autoPv) || void 0 === e ? void 0 : e.unload) && (k(),
                k = null),
                f.flush()
            };
            ...
            null != t && null !== (u = t.feature) && void 0 !== u && u.fingerPrint && !e.plugins.fp ? this.fpPromise = (F = "".concat("https://s1.hdslb.com/bfs/seed/jinkela/short/reporter-pb", "/fingerPrint.js"),
            new Promise((function(e) {
        ...
        return o(e, [{
            ...
            get: function() {
                var e;
                return (null === (e = this.options) || void 0 === e ? void 0 : e.spmPrefix) || I("spm_prefix")
            }
        }, {
            key: "_handleSpmId",
            value: function(e) {
                ...
                var t = e.prefix || this.spmPrefix || ""
                  , i = e.e ? ".".concat(e.e) : "";
                return t ? "".concat(t, ".").concat(e.c, ".").concat(e.d).concat(i) : ""
            }
        }, {
            key: "report",
            value: function(e, t, i, r) {
                var n = this
                  , o = this._handleSpmId(t);
                if (o) {
                    if (!this.miss && function(e) {
                        var t = Q("sampleRateConfig");
                        return !t || !t[e] || "number" != typeof t[e] || Math.ceil(100 * Math.random()) <= t[e]
                    }(o))
                        if ("tech" !== e) {
                            var a = Date.now()
                              , s = function() {
                                ...
                                null != r && r.flush && n.scheduler.flush()
                            };
                            if (this.buvidInit ? s() : this.initBuvidPromise.then(s),
                            "pv" === e) {
                                var u = o.split(".").slice(0, 4).concat("unload").join(".");
                                return function(e) {
                                    return n.report("pv_unload", u, l({
                                        pvStart: a
                                    }, null != e ? e : {}), r)
                                }
                            }
                        } else
                            this._techReport(o, i, r)
                } else
            ...
            value: function() {
                ...
                null === (e = this.techEventReporter) || void 0 === e || e.flush()
            }
        }, {
            key: "fpReport",
            value: (a = i(c().mark((function t(i) {
                return c().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
            ...
            key: "_techReport",
            value: (n = i(c().mark((function t(i, r, n) {
                var o;
                return c().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            this.techEventReporter || (dt("tech"),
                            this.techEventReporter = new e.plugins.tech(this.options,this.initBuvidPromise,this.sequencer)),
                            o = ["performance", "error", "player", "custom"].some((function(e) {
                                return e === (null == r ? void 0 : r.type)
                            }
                            )) ? r.type : "custom",
                            null == r || delete r.type,
                            this.techEventReporter.report(o, i, r, n);
                        case 4:
                        case "end":
                            return t.stop()
                        }
            ...
            value: (t = i(c().mark((function t() {
                ...
                return c().wrap((function(t) {
                    for (; ; )
                        ...
                        case 0:
                            return dt("native"),
                            t.abrupt("return", (i = e.plugins.native).reportNative.apply(i, r));
                        case 2:
                        case "end":
                            return t.stop()
                        }
            ...
            key: "use",
            value: function(e) {
                this.plugins = l(l({}, this.plugins), e)
            }
        }]);
        var t, n, a
    }();
    ...
    function mt(e, t) {
        if (e.navigation_start && t.writeFloatField(1, e.navigation_start),
        ...
        e.secure_connection_start && t.writeFloatField(10, e.secure_connection_start),
        ...
        e.dom_content_loaded_event_start && t.writeFloatField(16, e.dom_content_loaded_event_start),
        e.dom_content_loaded_event_end && t.writeFloatField(17, e.dom_content_loaded_event_end),
        ...
        e.cumulative_layout_shift && t.writeFloatField(21, e.cumulative_layout_shift),
        e.first_paint && t.writeFloatField(22, e.first_paint),
        e.first_contentful_paint && t.writeFloatField(23, e.first_contentful_paint),
        e.first_meaningful_paint && t.writeFloatField(24, e.first_meaningful_paint),
        e.largest_contentful_paint && t.writeFloatField(25, e.largest_contentful_paint),
        e.time_to_first_byte && t.writeFloatField(26, e.time_to_first_byte),
        e.extra)
            for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
                var n = r[i];
                t.writeMessage(27, gt, {
                    key: n,
                    value: e.extra[n]
                })
            }
    ...
    function yt(e, t) {
        ...
        if (e.extra)
            for (var o = 0, s = Object.keys(e.extra); o < s.length; o++) {
                var u = s[o];
                t.writeMessage(6, _t, {
                    key: u,
                    value: e.extra[u]
    ...
    var St = {
      ...
      , Et = function(e) {
        var t, i = null == e || null === (t = e.feature) || void 0 === t ? void 0 : t.tech;
        return i && "object" === p(i) && i.logId ? i.logId : null != e && e.DEBUG_TEST_CHANNEL ? "025205" : "021434"
    }
      , Vt = function(e, t) {
        var i, r, n = t.reporter.options, o = t.reporter.sequencer.get(), a = o.sn, s = o.time, u = {
            performance: function() {
                var t = ["type", "navigation_start", "unload_event_end", "redirect_start", "redirect_end", "fetch_start", "domain_lookup_start", "domain_lookup_end", "connect_start", "connect_end", "secure_connection_start", "request_start", "response_start", "response_end", "dom_loading", "dom_interactive", "dom_content_loaded_event_start", "dom_content_loaded_event_end", "dom_complete", "load_event_start", "load_event_end", "cumulative_layout_shift", "first_paint", "first_contentful_paint", "first_meaningful_paint", "largest_contentful_paint", "time_to_first_byte"];
                ...
                var i = z(l(l({}, null == n ? void 0 : n.extra), e.data), t)
                  , r = i.selected
                  , o = i.remain;
                return {
                    performance_info: l(l({}, H(r)), {}, {
                        extra: U(o)
                    })
                }
            },
            error: function() {
                var t = z(l(l({}, null == n ? void 0 : n.extra), e.data), ["errorType", "error_type", "name", "message", "stack", "instruments"])
                  , i = t.selected
                  , r = t.remain;
                return {
                    error_event_info: {
                        ...
                        stack: i.stack,
                        instruments: (Array.isArray(i.instruments) ? i.instruments : []).map((function(e) {
                            return R(e) ? H(e) : e
                        }
                        )),
                        extra: U(r)
            ...
            player: function() {
                return e.data = H(e.data),
                e.data.player_extra && R(e.data.player_extra) && (e.data.player_extra = U(e.data.player_extra)),
                {
                    player_info: e.data
                }
            },
            custom: function() {
                return {
                    extra: U(l(l(l(l({
                        app_buvid: N("Buvid")
                    }, Ue()), re()), null == n ? void 0 : n.extra), e.data))
                }
            }
        }, c = (null === (i = u[e.type]) || void 0 === i ? void 0 : i.call(u)) || {}, d = l(l({}, null === (r = e.options) || void 0 === r ? void 0 : r.base), null == n ? void 0 : n.base), f = l({
            info: ne(d),
            runtime_info: oe(d),
            event_id: e.spm,
            business: e.spm.split(".").slice(0, 1).join("."),
            ...
            ts: e.ts || 0,
            upload_time: Date.now(),
            event_category: St[e.type],
            extra: U(l(l(l(l({
                app_buvid: N("Buvid")
            }, Ue()), re()), null == n ? void 0 : n.extra), fe ? {
                _report_exp: pe ? 2 : 1
            } : {}))
        }, c), p = new je;
        !function(e, t) {
            if (e.info && t.writeMessage(1, wt, e.info),
            e.runtime_info && t.writeMessage(2, bt, e.runtime_info),
            e.event_id && t.writeStringField(3, e.event_id),
            e.business && t.writeStringField(4, e.business),
            e.sn && t.writeVarintField(5, e.sn),
            e.sn_gen_time && t.writeVarintField(6, e.sn_gen_time),
            ...
            e.upload_time && t.writeVarintField(8, e.upload_time),
            e.event_category && t.writeVarintField(9, e.event_category),
            e.performance_info && t.writeMessage(10, mt, e.performance_info),
            e.error_event_info && t.writeMessage(11, yt, e.error_event_info),
            e.player_info && t.writeMessage(12, xt, e.player_info),
            e.extra)
                for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
                    var n = r[i];
                    t.writeMessage(13, ht, {
                        key: n,
                        value: e.extra[n]
                    })
                }
        ...
        var v = p.finish();
        return (null == n ? void 0 : n.logLevel) >= 1 && console.log("%c".concat(e.type, " ").concat(e.spm, "\n"), "color: #30A46C", f),
        {
            log_id: Et(t.reporter.options),
            event_id: e.spm,
            body: v,
            meta: {
                metaEventId: e.spm,
                metaEventCategory: e.type
            }
        }
    }
      , Pt = function(e) {
      ...
      , Tt = function() {
        return o((function e(t, n, o) {
            var a, s = this;
            r(this, e),
            this.options = t,
            this.initBuvidPromise = (n || Ve()).then((function() {
                s.buvidInit = !0
            }
            )),
            this.sequencer = o || new M;
            var u, f = D(se, null === (a = this.options) || void 0 === a ? void 0 : a.batch);
            this.scheduler = new j(l(l({}, f.enabled ? f.value : {
                batchSize: 1,
                batchTime: 0
            }), {}, {
                run: (u = i(c().mark((function e(i) {
                    var r, n, o, a, u;
                    return c().wrap((function(e) {
                        for (; ; )
                            switch (e.prev = e.next) {
                            case 0:
                                o = Pt(i),
                                a = Et(s.options),
                                (null === (r = s.options) || void 0 === r ? void 0 : r.logLevel) >= 2 && (u = d(o).map((function(e) {
                                    return "0".concat(e.toString(16)).slice(-2)
                                }
                                )).join(" "),
                                console.log("log_id: %c".concat(a, "\n%crequest size: %c").concat(o.length, " bytes\n%crequest body:\n%c").concat(u), "color: #0090FF", "", "color: #0090FF", "", "background-color: #004744; color: #A8F5E5")),
                                ke(o, {
                                    url: null === (n = s.options) || void 0 === n || null === (n = n.base) || void 0 === n ? void 0 : n.url,
